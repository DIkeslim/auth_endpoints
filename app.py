...
# JWT Secret key
app.config['JWT_SECRET_KEY'] = '7890e4xdfB\xbf\xcd\x7f|X7^'

# Mongo DB Name
app.config['MONGO_DBNAME'] = 'chimdike'
app.config['MONGO_URI'] = "mongodb+srv://chimdike:" + \
    quote("chimdike1") + \
    "@cluster0.8xulw.mongodb.net/chimdike?retryWrites=true&w=majority"
...
if __name__ == "__main__":
    ...
    app.secret_key = "7890e4xdfB\xbf\xcd\x7f|X7^"
    app.run(debug=True)